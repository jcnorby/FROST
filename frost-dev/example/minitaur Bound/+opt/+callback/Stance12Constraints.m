function Stance12Constraints(nlp, bounds, varargin)
...
normalForces = [domain.Inputs.ConstraintWrench.fFoot1(3);domain.Inputs.ConstraintWrench.fFoot2(3)];
normal_forces_fun = SymFunction(['normalForces_', nlp.Name], normalForces, {domain.Inputs.ConstraintWrench.fFoot1,domain.Inputs.ConstraintWrench.fFoot2});

addNodeConstraint(nlp, normal_forces_fun, {'fFoot1', 'fFoot2'}, 'last', ...
    0, 0,'Linear');
