function Stance03Constraints(nlp, bounds, varargin)
...
normalForces = [domain.Inputs.ConstraintWrench.fFoot0(3);domain.Inputs.ConstraintWrench.fFoot3(3)];
normal_forces_fun = SymFunction(['normalForces_', nlp.Name], normalForces, {domain.Inputs.ConstraintWrench.fFoot0,domain.Inputs.ConstraintWrench.fFoot3});

addNodeConstraint(nlp, normal_forces_fun, {'fFoot0', 'fFoot3'}, 'last', ...
    0, 0,'Linear');
