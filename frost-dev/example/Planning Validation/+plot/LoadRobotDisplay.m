function vision60_disp = LoadRobotDisplay(robot, varargin)
...
vision60_disp = frost.Animator.Display(f, robot, opts);
...
name = 'body';
offset = [0,0,0.58];
torso_top = frost.Animator.Rectangler(vision60_disp.axs, robot, base, -0.5*[0.88 0.25 0.19],0.5*[0.88 0.25 0.19], name, opts);
vision60_disp.addItem(torso_top);
% base = CoordinateFrame(...
%     'Name','Base',...
%     'Reference',robot.Joints(getJointIndices(robot, 'BaseRotZ')),...
%     'Offset',[0,0,0],...
