function [new_gait, sol, info, total_time] = solve(nlp, x0, info)
    ...
    solver.Options.ipopt.dual_inf_tol = 1e-3; % 1e-3
    ...
    solver.Options.ipopt.acceptable_tol = 1e-3;
    solver.Options.ipopt.acceptable_constr_viol_tol = 1e-4;
    solver.Options.ipopt.acceptable_dual_inf_tol = 1e-3;
    solver.Options.ipopt.acceptable_compl_inf_tol = 1e-3;
