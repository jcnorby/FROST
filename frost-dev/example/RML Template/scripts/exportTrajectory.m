...
% Exports a trajectory to c++ code that can be run on the Minitaur. Must be
% adapted for different robots, but probably don't trust the values given
% here. Feel free to adapt to your own platform, but do not use this code
% as is.
