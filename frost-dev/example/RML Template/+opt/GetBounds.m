...
model_bounds.states.x.lb = [-10;-10;0;-pi/2;-pi/2;0;ab_lb;hip_lb;knee_lb;0;ab_lb;hip_lb;knee_lb;0;ab_lb;hip_lb;knee_lb;0;ab_lb;hip_lb;knee_lb;0];
model_bounds.states.x.ub = [10;10;3;pi/2;pi/2;0;ab_ub;hip_ub;knee_ub;0;ab_ub;hip_ub;knee_ub;0;ab_ub;hip_ub;knee_ub;0;ab_ub;hip_ub;knee_ub;0];

% model_bounds.states.dx.lb = [-4;-4;-100;0;-100;0;-100;-100;-100;-100;-100;-100;-100;-100;-100;-100;-100;-100;-100;-100;-100;-100];
% model_bounds.states.dx.ub = [4;4;100;0;100;0;100;100;100;100;100;100;100;100;100;100;100;100;100;100;100;100];
...
bounds.Flight.inputs.Control.u.lb = -1;
bounds.Flight.inputs.Control.u.ub = 1;
